...
async function doLogin() {
    ...
    try {
        ...
        if (!res.ok) {
            ...
            return showCustomAlert("Login Failed", data.error || "Incorrect credentials.", "danger");
        }
        ...
        loginBtn.innerHTML = originalText;
        showCustomAlert("Connection Error", "Cannot connect to the server. Make sure your backend is running.", "danger");
    }
}
